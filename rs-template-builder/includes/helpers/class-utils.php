	...
	public static function get_admin_data(): array {
		...
		return [
			...
			'adminStrings'    => [
				...
				'headerReplaceLabel'      => _x( 'Replace Specific Element', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'headerReplaceMsg'        => _x( 'Instead of replacing the full theme header, replace only a specific element matched by an ID or class selector.', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'headerSelLabel'          => _x( 'Header Replace Selector', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'headerSelMsg'            => _x( 'Enter an ID (#site-header) or class (.site-header) from your theme\'s header markup to replace only that element instead of the full header.', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'headerSelError'          => _x( 'Selector must start with # or . (e.g. #site-header or .site-header).', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'headerSelRequiredError'  => _x( 'Please enter a selector, or disable Replace Specific Element.', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerReplaceLabel'      => _x( 'Replace Specific Element', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerReplaceMsg'        => _x( 'Instead of replacing the full theme footer, replace only a specific element matched by an ID or class selector.', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerSelLabel'          => _x( 'Footer Replace Selector', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerSelMsg'            => _x( 'Enter an ID (#site-footer) or class (.site-footer) from your theme\'s footer markup to replace only that element instead of the full footer.', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerSelError'          => _x( 'Selector must start with # or . (e.g. #site-footer or .site-footer).', 'Admin - RS Template Builder', 'rs-template-builder' ),
				'footerSelRequiredError'  => _x( 'Please enter a selector, or disable Replace Specific Element.', 'Admin - RS Template Builder', 'rs-template-builder' ),
